...
public class ReferenceBuilder extends Builder {
	public static String buildAssignable(ParseTree ctx) throws ScriptBuildException {
		return ctx.getChild(0).getText(); 
		//TODO: This is not right;
		
	}
	
	public static Reference buildIdentifier(IdentifierContext ctx) throws ScriptBuildException {
