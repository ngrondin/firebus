...
public class SubstractSet extends ReferenceExpressionOperator {
	
	public SubstractSet(Reference r, Expression e, SourceInfo uc) {
		super(r, e, uc);
	}

	protected SValue getUpdateValue(SValue originalValue, SValue expressionValue) throws ScriptExecutionException {
		try {
			return Operations.substract(originalValue, expressionValue);
