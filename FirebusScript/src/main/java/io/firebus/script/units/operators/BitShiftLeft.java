...
public class BitShiftLeft extends TwoExpressionOperator {

	public BitShiftLeft(Expression e1, Expression e2, SourceInfo uc) {
		super(e1, e2, uc);
	}

	protected SValue evalWithValues(SValue v1, SValue v2) throws ScriptExecutionException, ScriptValueException {
		return Operations.bitShiftLeft(v1, v2);
	}
